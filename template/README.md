...
Project generated from [github.com/cedricss/elm-batteries](https://github.com/cedricss/elm-batteries), an Elm project template created by [Cédric Soulas](https://twitter.com/CedricSoulas).
